package com.sean.study.galleryeffect.helper;
...
public class CardScaleHelper {
    ...
    public void attachToRecyclerView(final RecyclerView mRecyclerView) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                Log.e(this.getClass().getSimpleName(), String.format("dx=%s, dy=%s, mScrolledX=%s", dx, dy, mCurrentItemOffset));
    ...
    private void computeCurrentItemPos() {
        ...
        if (pageChanged) {
            ...
            Log.e(this.getClass().getSimpleName(),String.format("=======onCurrentItemPos Changed======= tempPos=%s, mCurrentItemPos=%s", tempPos, mCurrentItemPos));
        }
    }
    ...
    private void onScrolledChangedCallback() {
        ...
        Log.e(this.getClass().getSimpleName(),String.format("offset=%s, percent=%s", offset, percent));
        View leftView = null;
        View currentView;
        View rightView = null;
